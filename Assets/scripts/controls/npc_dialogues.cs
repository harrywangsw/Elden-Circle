...
public static class npc_dialogues 
{
    public static List<string> thales = new List<string>(){
        ...
        //3
        @"Most of our actions can be rationalized and predicted, except for a small set of axiomatic actions that cannot. Me swerving to the left just then is an example of such action. "
    };
    ...
    public static List<string> hali = new List<string>(){
        ...
        *Sigh*, No matter. As far as I'm concerned, you've already finished the game
        ...
        //1
        "Welcome, traveller. To the advanturer's guild "
    };
}
